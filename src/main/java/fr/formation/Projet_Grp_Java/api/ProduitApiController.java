...
public class ProduitApiController {
        ...
        public void update(
                        ...
                        @RequestBody CreateOrUpdateProduitRequest request) {
                Produit existingProduit = repository.findById(id)
                                .orElseThrow(ProduitNotFoundException::new);

                existingProduit.setNom(request.getNom());
                existingProduit.setPrix(request.getPrix());
                existingProduit.setNotable(request.isNotable());

                repository.save(existingProduit);
        }
